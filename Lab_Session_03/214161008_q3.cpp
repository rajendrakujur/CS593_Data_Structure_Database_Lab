...
int main()
{
    ...
    while (1)
    {
        cout << "Enter list_1's next element : ";
        cin >> number;
        ...
        cout << "If you want to enter further enter 1 else 0\n";
        cin >> choice;

        // any number other than 0 will be considered as yes
        if (!choice)
        {
            break;
        }
    ...
    while (length--)
    {
        cout << "Enter list_2's next element : ";
        cin >> number;
